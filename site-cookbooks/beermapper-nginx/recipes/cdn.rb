...
domain_name = node['beermapper-nginx']['nginx']['evergreen_cdn_domain_name']
...
template '/opt/nginx/conf.d/cdn.evergreenmenus.conf' do
  source 'cdn.evergreenmenus.conf.erb'
  variables({
    evergreen_cdn_domain_name: domain_name,
